...
public class DataProvider {
    ...
    private static List<Ikan> initDataIkan(Context ctx) {
        ...
        ikans.add(new Ikan("Ikan Zebra", "Asia",
                "Ikan zebra adalah salah satu spesies ikan bermarga Danio dari keluarga siprinide.", R.drawable.ikan_zebra));
        ikans.add(new Ikan("Ikan Balasak", "Alaska,Siberia,Finlandia (daerah bersalju) ",
                "Hiu bala, Balantiocheilos melanopterus, juga dikenal sebagai hiu tricolor,", R.drawable.ikan_balasak));
        ikans.add(new Ikan("Ikan Diskus biru", "Indonesia",
                "Mereka berukuran maksimal 4 cm. Harapan hidupnya sekitar 3-5 tahunan.", R.drawable.ikan_diskusbiru));
        ikans.add(new Ikan("Ikan Neon hhitam", "Rusia",
                "Mereka berukuran maksimal 4 cm. Harapan hidupnya sekitar 3-5 tahunan.", R.drawable.ikan_neonhitam));
        ikans.add(new Ikan("ikan serpaetera", "Jerman",
                "termasuk ikan hias berukuran mungil. ", R.drawable.ikan_serpaetetra));
        ikans.add(new Ikan("Ikan Sumatra", "Indonesi",
                "Ikan sumatra adalah sejenis ikan kecil anggota suku Cyprinidae anak-suku Cyprininae. ", R.drawable.ikan_sumatra));
        return ikans;
    }
